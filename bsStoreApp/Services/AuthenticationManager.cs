    ...
    public class AuthenticationManager : IAuthenticationService
    {
        ...
        private JwtSecurityToken GenerateTokenOptions(SigningCredentials signinCredentials, List<Claim> claims)
        {
            ...
            var tokenOptions = new JwtSecurityToken(
                ...
                claims: claims,
                expires: DateTime.Now.AddMinutes(Convert.ToDouble(jwtSettings["expires"])), // AddHours ile bu zamanı arttırabilirsin
        ...
        private ClaimsPrincipal GetPrincipalFromExpiredToken(string token) // Kullanıcı bilgileri isteniyor
        {
            var jwtSettings = _configuration.GetSection("JwtSettings");
